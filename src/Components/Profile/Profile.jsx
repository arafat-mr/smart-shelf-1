...
const Profile = () => {
  ...
  const [loadingChart, setLoadingChart] = useState(true); // local loading for chart
    ...
    const fetchBooks = async () => {
      try {
        ...
        const res = await fetch(
          `https://virtual-bookshelf-server-ruddy.vercel.app/books?email=${user.email}`
        );
    ...
    <div>
      <div className="hero">
        <div className="hero-content flex-col lg:flex-row lg:gap-20">
          ...
          <div>
            ...
            <p className="py-2 text-2xl font-semibold">Name : {user.displayName}</p>
      ...
      {data && data.length ? (
        ...
        <div className="flex flex-col items-center justify-center h-96">
          ...
          <p className="text-xl md:text-3xl lg:text-4xl font-semibold text-red-600">
